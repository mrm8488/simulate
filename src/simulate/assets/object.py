...
class ProcgenGrid(Object3D):
    ...
    Args:
        sample_map (`np.ndarray` or `List[List[float]]`, *optional*, defaults to `None`):
            Map to procedurally generate from.
        specific_map (`np.ndarray` or `List[List[float]]`, *optional*, defaults to `None`):
            Map to show as it is.
        tiles (`list`, *optional*, defaults to `None`):
            ...
            more generic tiles.
        neighbors (`list`, *optional*, defaults to `None`):
            Neighbors for procedural generation when using generation from tiles and neighbors definitions.
        symmetries (`list`, *optional*, defaults to `None`):
        ...
        weights (`List[float]`, *optional*, defaults to `None`):
            Sampling weights for each of the tiles.
        width (`int`, *optional*, defaults to `9`):
            Width of the grid.
        height (`int`, *optional*, defaults to `9`):
            Height of the grid.
        shallow (`bool`, *optional*, defaults to `False`):
        ...
        algorithm_args (`dict`, *optional*, defaults to `None`):
        ...
        verbose (`bool`, *optional*, defaults to `False`):
            Whether to print the map generated or not.
    """
    ...
    def __init__(
        self,
        sample_map: Union[np.ndarray, List[List[int]]] = None,
        specific_map: Union[np.ndarray, List[List[int]]] = None,
